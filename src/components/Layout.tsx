...
const navigationItems: NavItem[] = [
  {
    ...
    path: '/dashboard',
    roles: ['sales', 'engineering', 'manager', 'ceo', 'finance', 'admin', 'solution_consultant', 'project_manager', 'purchasing', 'production', 'logistics', 'quality', 'warehouse'],
  },
  {
    labelKey: 'quotations',
    icon: FileText,
  ...
  },
  {
    ...
    roles: ['production', 'purchasing', 'engineering', 'project_manager', 'manager', 'quality', 'admin', 'ceo'],
  },
  {
    labelKey: 'warehouse',
    icon: Warehouse,
    path: '/warehouse-inventory',
    roles: ['warehouse', 'logistics', 'production', 'purchasing', 'engineering', 'admin', 'manager', 'ceo'],
  },
  {
  ...
  },
  {
    ...
    roles: ['quality', 'production', 'purchasing', 'engineering', 'project_manager', 'manager', 'admin', 'ceo', 'finance'],
  },
  {
    labelKey: 'qualityCosts',
    icon: DollarSign,
    path: '/quality-costs',
    roles: ['quality', 'purchasing', 'engineering', 'project_manager', 'admin', 'finance', 'ceo', 'manager'],
  },
  {
  ...
  },
  {
    ...
    icon: Bell,
    path: '/quality-alerts',
    roles: ['quality', 'production', 'purchasing', 'engineering', 'project_manager', 'admin', 'manager', 'ceo'],
  },
  {
    labelKey: 'shipments',
    icon: Truck,
