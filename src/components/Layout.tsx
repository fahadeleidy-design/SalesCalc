...
const navigationItems: NavItem[] = [
  {
    ...
    path: '/dashboard',
    roles: ['sales', 'engineering', 'manager', 'group_ceo', 'ceo_commercial', 'ceo_manufacturing', 'finance', 'admin', 'solution_consultant', 'project_manager', 'purchasing', 'production', 'logistics', 'quality', 'warehouse'],
  },
  {
    labelKey: 'quotations',
    icon: FileText,
    path: '/quotations',
    roles: ['sales', 'finance', 'group_ceo', 'ceo_commercial', 'manager', 'solution_consultant'],
  },
  {
  ...
  },
  {
    ...
    icon: Target,
    path: '/crm',
    roles: ['sales', 'manager', 'group_ceo', 'ceo_commercial', 'solution_consultant'],
  },
  {
    labelKey: 'products',
    icon: Package,
  ...
  },
  {
    ...
    roles: ['finance', 'group_ceo', 'ceo_commercial', 'admin', 'engineering', 'solution_consultant', 'purchasing'],
  },
  {
    labelKey: 'collection',
    icon: TrendingUp,
    path: '/collection',
    roles: ['sales', 'manager', 'finance', 'group_ceo', 'ceo_commercial', 'admin'],
  },
  {
    labelKey: 'profitability',
    icon: TrendingUp,
    path: '/profitability',
    roles: ['finance', 'group_ceo', 'ceo_commercial', 'admin'],
  },
  {
    labelKey: 'demos',
    icon: Target,
  ...
  },
  {
    ...
    roles: ['solution_consultant', 'manager', 'group_ceo', 'ceo_commercial'],
  },
  {
    labelKey: 'targets',
    icon: Target,
  ...
  },
  {
    ...
    icon: BarChart3,
    path: '/custom-reports',
    roles: ['finance', 'group_ceo', 'ceo_commercial', 'admin', 'solution_consultant'],
  },
  {
    labelKey: 'users',
    icon: Users,
  ...
  },
  {
    ...
    roles: ['project_manager', 'group_ceo', 'ceo_manufacturing', 'manager'],
  },
  {
    labelKey: 'timesheets',
    icon: Timer,
  ...
  },
  {
    ...
    roles: ['project_manager', 'finance', 'group_ceo', 'ceo_manufacturing'],
  },
  {
    labelKey: 'resourceUtilization',
    icon: Users,
    path: '/resource-utilization',
    roles: ['project_manager', 'manager', 'group_ceo', 'ceo_manufacturing'],
  },
  {
  ...
  },
  {
    ...
    roles: ['purchasing', 'finance', 'group_ceo', 'ceo_manufacturing', 'admin'],
  },
  {
  ...
  },
  {
    ...
    roles: ['purchasing', 'finance', 'group_ceo', 'ceo_manufacturing', 'admin', 'manager'],
  },
  {
  ...
  },
  {
    ...
    roles: ['production', 'purchasing', 'engineering', 'project_manager', 'manager', 'quality', 'admin', 'group_ceo', 'ceo_manufacturing'],
  },
  {
    labelKey: 'warehouse',
    icon: Warehouse,
    path: '/warehouse-inventory',
    roles: ['warehouse', 'logistics', 'production', 'purchasing', 'engineering', 'admin', 'manager', 'group_ceo', 'ceo_manufacturing'],
  },
  {
    labelKey: 'warehouseOperations',
    icon: ClipboardList,
    path: '/warehouse-operations',
    roles: ['warehouse', 'logistics', 'purchasing', 'project_manager', 'engineering', 'manager', 'admin'],
  },
  {
    labelKey: 'stockMovements',
    icon: ArrowUpDown,
    path: '/stock-movements',
    roles: ['warehouse', 'logistics', 'purchasing', 'admin', 'manager'],
  },
  {
    labelKey: 'qualityControl',
    icon: ClipboardCheck,
    path: '/quality-inspections',
    roles: ['quality', 'production', 'purchasing', 'engineering', 'project_manager', 'manager', 'admin', 'group_ceo', 'ceo_manufacturing', 'finance'],
  },
  {
    labelKey: 'qualityCosts',
    icon: DollarSign,
    path: '/quality-costs',
    roles: ['quality', 'purchasing', 'engineering', 'project_manager', 'admin', 'finance', 'group_ceo', 'ceo_manufacturing', 'manager'],
  },
  {
    labelKey: 'samplingPlans',
    icon: Calculator,
    path: '/sampling-plans',
    roles: ['quality', 'purchasing', 'engineering', 'project_manager', 'admin', 'manager'],
  },
  {
    labelKey: 'qualityAlerts',
    icon: Bell,
    path: '/quality-alerts',
    roles: ['quality', 'production', 'purchasing', 'engineering', 'project_manager', 'admin', 'manager', 'group_ceo', 'ceo_manufacturing'],
  },
  {
    labelKey: 'shipments',
    icon: Truck,
    path: '/shipments',
    roles: ['logistics', 'warehouse', 'purchasing', 'project_manager', 'manager', 'admin', 'group_ceo', 'ceo_manufacturing'],
  },
  {
  ...
  },
  {
    ...
    icon: Wrench,
    path: '/installations',
    roles: ['logistics', 'warehouse', 'project_manager', 'manager', 'admin', 'group_ceo', 'ceo_manufacturing'],
  },
  {
  ...
  },
  {
    ...
    icon: Factory,
    path: '/manufacturing',
    roles: ['production', 'quality', 'warehouse', 'logistics', 'purchasing', 'engineering', 'project_manager', 'manager', 'admin', 'group_ceo', 'ceo_manufacturing'],
  },
  {
