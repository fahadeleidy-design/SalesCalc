  ...
  const getPageContent = () => {
    ...
    switch (currentPath) {
      ...
      case '/governance-reports':
        return hasAccess(['admin', 'ceo', 'group_ceo', 'ceo_commercial', 'ceo_manufacturing']) ? <GovernanceReportsPage /> : <UnauthorizedPage />;
      ...
      case '/route-planning':
        return hasAccess(['logistics', 'purchasing', 'project_manager', 'manager', 'admin']) ? <RoutePlanningPage /> : <UnauthorizedPage />;
